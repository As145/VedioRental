...
/****** Object:  Database [VBMOVIESFULLDATA.MDF]    Script Date: 2/08/2021 7:40:46 PM ******/
...
( NAME = N'VBMoviesFullData', FILENAME = N'C:\DATABASE\VBMoviesFullData.mdf' , SIZE = 9216KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'VBMoviesFullData_log', FILENAME = N'C:\DATABASE\VBMoviesFullData_log.ldf' , SIZE = 504KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
...
ALTER DATABASE [VBMOVIESFULLDATA.MDF] SET AUTO_CLOSE ON 
GO
